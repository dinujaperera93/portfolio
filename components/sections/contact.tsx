    ...
    <div className="max-w-7xl mx-auto">
          ...
          <Card className="p-8 border-none shadow-2xl bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white h-full flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-3">
              <Button
                ...
                size="lg"
                onClick={() =>
                  (window.location.href = "mailto:dinujakdr@gmail.com")
                }
              >
      ...
      >
        ...
        <p className="text-gray-700 dark:text-gray-300 max-w-2xl mx-auto">
          I&apos;m particularly interested in projects involving Applied Machine
          Learning, MLOps, Cloud Computing, NLP, and Time-Series Analysis.
          <span className="mt-2 block">
            Let&apos;s discuss how we can work together to build innovative AI
            solutions.
          </span>
        </p>
      </motion.div>
